...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        premium: 'إعلان مهم هذه الميزة مدفوعة واذا اردت الاستفادة منها بالمجان شارك هذا الفيديو مع 10 من اصدقائك ثم أشر اليهم في تعليق و ارسل سكرين شوت انك فعلت كل هذا في الانستغرام الخاص بك \n https://facebook.com/717952876999145 \n رابط انستغرامي: \n instagram.com/noureddine_ouafy',
        group: '*[ ⚠️ تنبيه ⚠️ ] لا يمكن استخدام هذا الكود إلا بواسطة المالك*',
        private: '*[ ⚠️ تنبيه ⚠️ ] 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙿𝚄𝙴𝙳𝙴 𝚂𝙴𝚁 𝚄𝚃𝙸𝙻𝙸𝚉𝙰𝙳𝙾 𝙴𝙽 𝙲𝙷𝙰𝚃 𝙿𝚁𝙸𝚅𝙰𝙳𝙾 𝙳𝙴𝙻 𝙱𝙾𝚃*',
        admin: '*[ ⚠️ 𝐀𝐋𝐄𝐑𝐓𝐀 ⚠️ ] 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾𝙻𝙾 𝙿𝚄𝙴𝙳𝙴 𝚂𝙴𝚁 𝚄𝚃𝙸𝙻𝙸𝚉𝙰𝙳𝙾 𝙿𝙾𝚁 𝙰𝙳𝙼𝙸𝙽𝚂 𝙳𝙴𝙻 𝙶𝚁𝚄𝙿𝙾*',
        botAdmin: '*[ ⚠️ تنبيه ⚠️ ] يجب أن يكون البوت أدمين بالمجموعة لتتمكن من استخدام هذا الكود*',
        unreg: '*[ 🛑 مرحبا!! انت غير مسجل 🛑 ]*\n\n استخدم هذا الكود للتسجيل*\n*➣ #verificar name.age*',
        restrict: '*[ ⚠️ تنبيه ⚠️ ] هذا الكود تم إيقافه بواسطة المالك*'
    }[type]
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: 'Instagram', body: 'Aymane Touzani', thumbnail: imagen1, sourceUrl: 'https://instagram.com/tzaym1' }}}}, { quoted: m })
